...
namespace Swift
{
	public unsafe class SwiftCoreLib : NativeLib
	{
		...
		SwiftType? _double;
		public SwiftType Double => _double ??= new SwiftType (this, "Sd", typeof (Double));

		SwiftType? _int8;
		public SwiftType Int8 => _int8 ??= new SwiftType (this, "Swift", "Int8", SwiftTypeCode.Struct);

		SwiftType? _int16;
		public SwiftType Int16 => _int16 ??= new SwiftType (this, "Swift", "Int16", SwiftTypeCode.Struct);

		SwiftType? _int32;
		public SwiftType Int32 => _int32 ??= new SwiftType (this, "Swift", "Int32", SwiftTypeCode.Struct);

		SwiftType? _int64;
		public SwiftType Int64 => _int64 ??= new SwiftType (this, "Swift", "Int64", SwiftTypeCode.Struct);

		public SwiftType Optional (SwiftType wrapped)
			=> new SwiftType (GetOptionalType (0, wrapped.Metadata), genericArgs: new[] { wrapped });

		SwiftType? _string;
		public SwiftType String => _string ??= new SwiftType (this, "SS", typeof (String));

		SwiftType? _unsafeRawPointer;
		public SwiftType UnsafeRawPointer => _unsafeRawPointer ??= new SwiftType (this, "SV");
